...
```
    ...
    ##                    t0                  t1
    ## 1 03/02/2019 15:00:00 03/02/2019 15:08:18
    ## 2 03/02/2019 15:08:18 03/02/2019 15:26:08
    ## 3 03/02/2019 15:26:08 03/02/2019 15:37:13
    ## 4 03/02/2019 15:37:13 03/02/2019 15:41:12
    ## 5 03/02/2019 15:41:12 03/02/2019 15:57:21
    ## 6 03/02/2019 15:57:21 03/02/2019 16:01:21
...
```
    ...
    ##          [,1]     [,2] [,3]
    ## [1,] 15.00000 15.13845    1
    ## [2,] 15.13845 15.43580    1
    ## [3,] 15.43580 15.62044    1
    ## [4,] 15.62044 15.68678    1
    ## [5,] 15.68678 15.95597    1
    ## [6,] 15.95597 16.02259    1
...
```
    ...
    ##          [,1]     [,2] [,3]
    ## [1,] 15.00000 15.13833    1
    ## [2,] 15.13833 15.43556    1
    ## [3,] 15.43556 15.62028    1
    ## [4,] 15.62028 15.68667    1
    ## [5,] 15.68667 15.95583    1
    ## [6,] 15.95583 16.02250    1
...
QuadratureIntegral = function(mat,cpar,d){
  if(is.null(mat) || is.na(mat)){return(1)}
  if(is.numeric(mat)){
...
LogLikelihood =function(dat,cpar,d){
  if(cpar[5]<=0 || cpar[6]<=0 || mu_w<=mu_s || lambda_s < 0 || lambda_w <0){
    return(-Inf)
  }
  labels=unique(dat[,3])
  ls_ids = list()
...
```
    ...
    ##  Avg. time to sleep = 1:38 (+/- 1.2 hour)
    ##  Avg. time to wake  = 9:38 (+/- 1.2 hour)
    ##  Rate (per hour) of frequency of phone use while asleep = 1.85695
    ##  Rate (per hour) of frequency of phone use while awake = 6.25784
...
```
    ...
    ## 1  03/03/2019 01:25:23 03/03/2019 08:28:27
    ## 2  03/04/2019 00:24:09 03/04/2019 08:46:00
    ## 3  03/05/2019 02:54:54 03/05/2019 10:17:53
    ## 4  03/06/2019 01:30:18 03/06/2019 08:26:11
    ## 5  03/07/2019 01:18:00 03/07/2019 10:15:10
    ## 6  03/08/2019 01:51:41 03/08/2019 09:06:40
    ## 7  03/09/2019 02:09:20 03/09/2019 10:28:38
    ## 8  03/10/2019 02:34:35 03/10/2019 10:23:01
    ## 9  03/11/2019 02:24:06 03/11/2019 10:00:56
    ## 10 03/12/2019 01:24:49 03/12/2019 09:02:36
